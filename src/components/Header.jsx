    ...
    >
      <div className="flex items-center gap-3">
        ...
        <h1
          ...
          className="text-2xl font-bold font-serif text-shamiRed tracking-wider select-none"
        >
          シャミコピー
        </h1>
      </div>
      ...
      <div
        ...
        className="text-sm font-bold text-nouaiBlue/80 truncate max-w-[40%] bg-nouaiBlue/5 px-3 py-1 rounded"
      >
