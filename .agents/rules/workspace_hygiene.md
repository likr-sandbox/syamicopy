...
2. **Maintain Context in .agents/AGENTS.md:**
   - Summarize critical project context, architectural decisions, and important instructions into `.agents/AGENTS.md`.
   - Always refer to `.agents/AGENTS.md` before making architectural changes.
   - Update `.agents/AGENTS.md` whenever new important decisions are made or when overriding previous constraints.
